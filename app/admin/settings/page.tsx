  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-slate-600 mt-1">Manage your company preferences</p>
      </div>
      ...
      <div className="max-w-2xl space-y-6">
        ...
        {/* Shift Settings */}
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h2 className="text-lg font-semibold text-slate-900 mb-4">Shift Configuration</h2>
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Default Shift Hours</label>
            ...
            <div className="flex items-center gap-2">
              ...
              <label className="text-sm text-slate-700">Enable shift overlap warnings</label>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" defaultChecked className="w-4 h-4" />
              <label className="text-sm text-slate-700">Require password change every 90 days</label>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Daily Rate per Rig</label>
              <div className="flex items-center gap-2">
