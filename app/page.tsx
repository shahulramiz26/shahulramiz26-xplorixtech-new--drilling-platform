    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
      <div className="text-center max-w-2xl px-6">
        <div className="mb-8">
          ...
          <p className="text-xl text-blue-400 font-medium tracking-widest">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-slate-400">
          ...
          <div className="p-4 bg-slate-800/50 rounded-lg">
            <div className="font-semibold text-white mb-1">AI Analytics</div>
